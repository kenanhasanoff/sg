...
var slotConfig3x5 = {
    ...
    symbolSizeY: 213,    //размер символа по вертикали или расстояние между символами
    spinTime: 2000,                 // time, milliseconds
    winShowTime: 3000,              // time, milliseconds
    showWinCoinsMessage : true,    // displaying a message with the amount of money won
    winMessageTime: 500,           // win message show time
...
*/
    ...
    createInfoPUHandler: function(popup)
    {
        ...
        createSpecSymbolPlate(popup, specialContainer, 'Jackpot', -490 , 225 + 10 , 'Любые Any 6 jackot symbols scattered on the screen = Jackpot Win.');
